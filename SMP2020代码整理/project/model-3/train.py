...
# 运行脚本
# python train_lstmType2.py --bert_path E:/PretrainedModel/chinese_roberta_wwm_large_ext_pytorch --max_seq_len 250 --learning_rate 0.000005 --batch_size 2 --epochs 10 --patience 2 --model_name bert_bilstmType2_fold{}.bin --dropout 0.3 --hidden_size 32 --output_path ./{}_bert_bilstmType2_result.txt