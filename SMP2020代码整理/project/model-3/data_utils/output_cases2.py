...
from .utils import UtilForCrossValidation, UtilForCrossValidationUsualVirus
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', type=str, required=True, help='输出文件路径, ./dev_fold{}.csv')
