...
from model.bilstmType2 import BertLSTMSoft as BertFC
...
if __name__ == "__main__":
    ...
    if platform.system() == 'Windows':
        bert_path = r'../pytorch_robert_ext_wwm_large'
    else:
        bert_path = '../pytorch_robert_ext_wwm_large'
    ...
    parser.add_argument('--model_save_path', type=str, default='./model/ckpt', help='模型存放目录')
    ...
    parser.add_argument('--train_folder', type=str, default=r'./data', help='训练文件夹')
...
# 运行脚本
# python train_lstmType2_pseudo.py --bert_path E:/PretrainedModel/chinese_roberta_wwm_large_ext_pytorch --max_seq_len 250 --learning_rate 0.000005 --batch_size 2 --epochs 10 --patience 2 --model_name bert_bilstmType2_pseudo_fold{}.bin --dropout 0.3 --hidden_size 32 --output_path ./{}_bert_bilstmType2_pseudo_result.txt --train_folder ./data_pseudo