...
# from data_utils.utils import UtilForCrossValidationEmoji
# from model.bert import BertFC
import log
from bert import BertFC
from utils import UtilForCrossValidationEmoji
...
def train(args):
    ...
    util = UtilForCrossValidationEmoji(vocab_path=args.vocab_path,
                                       max_seq_len=args.max_seq_len,
                                       batch_size=args.batch_size,
                                       label_dict_path=args.label_dict_path,
                                       emoji_dict_path=args.emoji_dict_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--emoji_dict_path', type=str, default=r'./data/emoji_dict.json', help='表情转文字')
    parser.add_argument('--vocab_path', type=str, default=r'./data/vocab.txt')
